...
\documentclass[11pt,fleqn,usenatbib]{mnras} % mnras
% \documentclass[11pt,usenatbib]{article} % mnras
...
\input{sections/cover-page.tex} %%% This works!
...
% \input{sections/word-counter.tex}
...
% \input{sections/mergers-morphology.tex} moved to the introduction.
...
\appendix
\input{appendices/Visual-classification.tex}
