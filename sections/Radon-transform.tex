...
\citet{2018MNRAS.480.2217S} apply a modification to the Radon transform defined in Eqn. (\ref{eqn:radon}), taking the integral of the absolute values of the velocity field difference of each point $v(x_i,y_i)$ and the mean of all values along the line segment.

\begin{equation}
    \label{eqn:radon}
    R(\rho,\theta)=\int{| v(x,y) - \langle v(x,y) \rangle | \, \diff l},
\end{equation}
