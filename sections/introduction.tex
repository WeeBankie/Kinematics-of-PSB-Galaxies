...
As a visualisation of this scenario it is of interest to note that \citet{Mutch_2011} assert that large spiral Sa/SBa type galaxies such as the Milky Way and the Andromeda galaxy M31 are in evolutionary transition from star-forming to passive galaxies due to the past consumption of much of their cold gas and now lie within the green valley.
...
Post-starburst (PSB) galaxies are those galaxies where their spectra indicate that star formation has ceased within the past gigayear or so. The is no spectral evidence of young O and B-type stars which will have gone supernova in that time. PSB spectra are dominated by the strong Balmer absorption lines H$\beta$, H$\gamma$, H$\delta$ typical of A-type stars. Emission lines characteristic of ongoing star formation such as [OII] 3727\AA\ are weak or absent \citep{2001ApJ...547L..17B,2003PASJ...55..771G,2004MNRAS.355..713B,2005MNRAS.357..937G,2018MNRAS.477.1708P}. The morphology of PSBs is often that of early-type ellipticals. PSBs are therefore also referred to as E+A or k+A galaxies. These observations indicate a brief burst of star formation in the past 1 to 2 Gyr which has subsequently ceased, or been 'quenched'. This is indicative that PSB galaxies are in transition on an evolutionary pathway from active star-forming galaxies to passive spheroids \citep{2004MNRAS.355..713B,2012MNRAS.420..672S,2013MNRAS.429.2212M}. \citet{2004MNRAS.355..713B} using a sample of a sample of low-redshift (z~0.1) E+A galaxies from the 2dF Galaxy Redshift Survey (2dFGRS)find evidence of major mergers, such as tidal tails, and conclude that major mergers are an important formation mechanism for E+A PSB galaxies.

[TODO: reformulate the following paragraph] Vivienne has been involved in the preparation of a number of papers researching PSBs: \citet{2017MNRAS.472.1401A} regarding the relationship between quenching of star formation and morphological transition, while \citet{2016MNRAS.463..832W} sets out the background work.
