...
Galaxy group &  & (Type-C) & (Type-IB) & (Type-OB) & (Type-IB+OB) & (Type-A) & (NC) \\
 \hline
CPSBs & 28 & 1 (26\%) & 4 (22\%) & 5 (19\%) & 5 (19\%) & 13 (15\%) & - \\
CPSB controls & 29 & 2 (21\%) & 3 (21\%) & 1 (21\%) & 5 (17\%) & 18 (17\%) & 1 \\
RPSBs & 36 & 1 (39\%) & 6 (14\%) & 7 (14\%) & 5 (14\%) & 17 (19\%) & - \\
RPSB controls & 36 & 0 (32\%) & 4 (13\%) & 4 (10\%) & 7 (13\%) & 19 (32\%) & 2 \\
\hline
Totals & 129 & \multicolumn{1}{l}{4 (30\%)} & 17 (18\%) & 17 (15\%) & 22 (15\%) & 67 (21\%) & 3 \\
\hline
\end{tabular}
\end{table*}

Comparing the Radon profile visual classification results in Table \ref{tab:Radon-VC-results} and Table \ref{tab:Radon-VC2-results} we note an apparent skew in the classifications of Type-C, constant, and Type-A, asymmetric profiles. This may be due to the similarity of the examples given in Figure 5 of Stark et al. (2018). Both the example profiles display some measure of asymmetry and also show a relatively constant profile in their central regions, around $\rho=0$. In fact there is some indication of inner bend features in both the Type-C and Type-A examples. So visual classification is difficult, and this conclusion was noted by both classifiers. We continue further discussion on this point in Section \ref{sec:discussion}. Setting aside the difficulties of Type-A and Type-C classifications, we note that similar numbers of profiles with bend features, Type-OB, Type-IB and Type-OB+IB were identified by both classifiers. 