...
As noted earlier post-starburst galaxies or PSB regions of galaxies can be identified from their spectra typically exhibiting the strong Balmer absorption lines of A-type stars. In addition, weak emmission lines of H$\alpha$ and [OII] emission lines indicate a quiescent state with little or no present star formation. The PSB sample employed in this work is that obtained from the sampling criteria adopted by Chen et al. (2019 in preparation, personal communication).
